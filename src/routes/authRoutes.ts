...
router.get('/logout', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    res.clearCookie("accessToken", { sameSite: process.env.NODE_ENV === 'production' ? 'none' : 'lax', secure: process.env.NODE_ENV === 'production', httpOnly: true });
    res.clearCookie("refreshToken", { sameSite: process.env.NODE_ENV === 'production' ? 'none' : 'lax', secure: process.env.NODE_ENV === 'production', httpOnly: true });
    res.json({
      status: 'success',
